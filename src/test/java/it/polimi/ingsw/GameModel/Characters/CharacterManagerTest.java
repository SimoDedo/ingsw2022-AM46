...
class CharacterManagerTest {
    ...
    /**
     * Test for C10. EFFECT: In Setup, draw 4 Students and place them on this card. Take 1 Student  from this card and
     * place it in your Dining Room. Then, draw a new Student from the Bag and place it on this card.
     * We select a random card student and save its color. The after activating the ability, we ensure that the card no
     * longer contains the selected student and that it is instead contained in the table of the saved color. Finally,
     * we ensure that a new student has been placed on the card.
     */
    @Test
