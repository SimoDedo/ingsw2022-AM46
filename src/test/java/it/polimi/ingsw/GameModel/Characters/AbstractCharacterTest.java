...
class AbstractCharacterTest {
    ...
    void isFirstUse() {
        ...
        test.awardCoin();
        test.awardCoin();
        char11.useCharacter(test, coinBag);
    ...
    void wasUsedThisTurn() throws FullTableException {
        ...
        test.awardCoin();
        test.awardCoin();
        assertThrows(IllegalStateException.class, () -> char10.useCharacter(test, coinBag));
        test.addToDR(new Student(Color.RED, null));
        char10.useCharacter(test, coinBag);
    ...
    void getCost() {
        ...
        test.awardCoin();
        test.awardCoin();
        char9.useCharacter(test, coinBag);
    ...
    void resetUseState() {
        ...
        test.awardCoin();
        test.awardCoin();
        char8.useCharacter(test, coinBag);
    ...
    void useAbility() {
        ...
        test.awardCoin();
        test.awardCoin();
        char6.useCharacter(test, coinBag);
