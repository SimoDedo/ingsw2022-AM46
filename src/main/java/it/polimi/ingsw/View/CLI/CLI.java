...
public class CLI implements UI {
    ...
    public void updateSetup(ObservableByClient game, UserActionType actionTaken) {
        update(game);
        if(actionTaken == UserActionType.TOWER_COLOR && ! game.getAvailableTowerColors().isEmpty()){
        ...
        else if(actionTaken == UserActionType.WIZARD && ! game.getAvailableWizards().isEmpty()){
    ...
    private void displayWelcome() {
        clearScreen();
        List<String> welcome = WelcomeScreen.getWelcome();
        for (String welcomeN : welcome)
